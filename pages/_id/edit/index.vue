<template>
  <v-layout column>
    <v-card-title class="title font-weight-regular justify-space-between">
      <span>Редактирование объекта "{{old.title}}"</span>
    </v-card-title>
    ...
    <v-btn color="success" @click="update">Сохранить</v-btn>
...
<script>
import editScript from "./default.js";
export default editScript({ type: "project" });
</script>