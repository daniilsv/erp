  ...
  data() {
    return {
      items: [
        ...
        { icon: "fa-project-diagram", title: "Проекты", to: "/content?type=project" },
        { icon: "fa-tasks", title: "Задачи", to: "/content?type=task" },
        { icon: "fa-sticky-note", title: "Заметки", to: "/content?type=note" },
        { icon: "fa-bug", title: "Багтрекер", to: "/content?type=bug" },
        { icon: "fa-sort-numeric-down", title: "Счетчики", to: "/content?type=counter" },
        { icon: "fa-clock", title: "Таймеры", to: "/content?type=timer" },
        { icon: "fa-stopwatch", title: "Секундомеры", to: "/content?type=stopwatch" },
